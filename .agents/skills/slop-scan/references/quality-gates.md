...
How the `pr-deslop` skill and this skill find the project's formatter,
...
- the `pr-deslop` skill resolves them at Step 3 and runs them in the conflict
  loop (Step 11) and final verification (Step 12).
- this skill resolves them at Step 3 and runs them before each
