---
name: merge-pr-multiple
description: >-
  Merge a set of PRs one at a time — detect stack vs independent set, rebase
  and resolve conflicts between merges, watch CI, merge each via gh
