#!/bin/sh
# apply-template.sh — POSIX shell template for this skill apply.sh.
#
...
if [ "$current_sha256" != "__REGISTRY_SHA256__" ]; then
    ...
    echo "  re-run this skill to materialize a fresh patch series" >&2
    exit 1
fi
...
echo "apply.sh: to autosquash, run this skill --apply-rebase or:"
