...
The pass that became the `spike-loop` skill is this skill run by hand. The
...
That is this skill scoped to `spike`, plus the YAGNI
...
**Landed as:** the `spike-loop` skill ([#74](https://github.com/tony/skills/pull/74),
