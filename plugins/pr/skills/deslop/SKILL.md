...
|---|---|---|
| `/pr:review-pr` | The PR description on GitHub | Read-only — only reports findings, per its *Rules* section in `../review-pr/SKILL.md`. |
...
quality-patterns table (`../review-pr/SKILL.md`).
...
- `../review-pr/SKILL.md` — the "No brittle
