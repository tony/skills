...
Run the analysis exactly as `/disk:usage` specifies, including its
reference reading. Do not shortcut it because this command will
execute — the classification is what makes execution safe.
