...
description: Use when a session starts on unfamiliar or resumed work — when asked to catch up, come up to speed, get oriented, or figure out where things left off and what you were in the middle of, what a branch is doing, what a pull request or its review threads are asking for, or what state this repo is in before you change anything in it.
...
looking for five lines, and the `brief` skill answers it; `/situate:what`
